...
{
	[DataObject(true)]
	public partial class PortletProperty : ITable<int>
	{
		#region Static Methods
		
		#region Common Methods

		protected static PortletPropertyCollection FillCollection (SqlCommand command)
		{
			PortletPropertyCollection list = new PortletPropertyCollection();
			...
			try
			{
				...
				using(SqlDataReader reader = command.ExecuteReader())
				{
					if (reader.HasRows)
					{
						...
						while (reader.Read()) 
						{
							PortletProperty entity = new PortletProperty();
		...
		protected static PortletProperty FillEntity (SqlCommand command)
		{
			PortletProperty entity = null;
		...
		public static PortletPropertyCollection GetList (string where, string orderBy)
		{
			StringBuilder sb = new StringBuilder(10);
			
			sb.Append(@"select * from [PortletProperty] ");
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static PortletPropertyCollection GetList (string where)
		{
			return GetList(where, String.Empty);
		}
		
		[DataObjectMethod(DataObjectMethodType.Select, true)]
		public static PortletPropertyCollection GetList ()
		{
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static PortletProperty GetFirst (string where, string orderBy)
		{
			StringBuilder sb = new StringBuilder(10);
			
			sb.Append(@"select top 1 * from [PortletProperty] ");
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static PortletProperty GetFirst (string where)
		{
			return GetFirst(where, String.Empty);
		}
	
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static PortletProperty GetFirst ()
		{
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static PortletProperty GetLatest (string where)
		{
			return GetFirst(where, "ModifiedDT desc");
		}
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static PortletProperty GetLatest ()
		{
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static PortletProperty GetByPortletIDAndPropertyGroupAndName(int portletID, string propertyGroup, string name, string orderBy)
		{
			return GetFirst("PortletID = " + portletID + " and PropertyGroup = '" + propertyGroup + "' and Name = '" + name + "'", orderBy);
		}
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static PortletProperty GetByPortletIDAndPropertyGroupAndName(int portletID, string propertyGroup, string name)
		{
			return GetByPortletIDAndPropertyGroupAndName(portletID, propertyGroup, name, String.Empty);
		}
		...
		protected static bool InsertOrUpdate (int portletID, string propertyGroup, string name, string value)		
		{
			using(SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["ManagedFusion"].ConnectionString))
			{
				using (SqlCommand command = connection.CreateCommand())
				{
					command.CommandText = "ManagedFusion_PortletProperty";
		...
		public static bool Insert (int portletID, string propertyGroup, string name, string value)
		{
		...
		public static bool Insert (PortletProperty entity)
		{
		...
		public static bool Update (int portletID, string propertyGroup, string name, string value)
		{
			return InsertOrUpdate(
				portletID,
				propertyGroup,
		...
		public static bool Update (PortletProperty entity)
		{
			entity.AcceptChanges();
			return InsertOrUpdate(
				entity.PortletID, 
		...
		public static bool Delete (PortletProperty entity)
		{
			entity.AcceptChanges();
			return Delete(
				entity.PortletID, 
		...
		[DataObjectMethod(DataObjectMethodType.Delete, true)]
		public static bool Delete (int portletID, string propertyGroup, string name)
		{
			using(SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["ManagedFusion"].ConnectionString))
			{
				using (SqlCommand command = connection.CreateCommand())
				{
					command.CommandText = "ManagedFusion_PortletProperty_Delete";
					command.CommandType = CommandType.StoredProcedure;
		...
		/// Column PortletID : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "PortletProperty"</remarks>
		...
		///<summary>
		/// Creates a new <see cref="PortletProperty"/> instance.
		///</summary>
		///<param name="PortletID"></param>
		///<param name="PropertyGroup"></param>
		///<param name="Name"></param>
		///<param name="Value"></param>
		public PortletProperty (int portletID, string propertyGroup, string name, string value)
		{
		...
		internal void Merge (PortletProperty entity)
		{
	...
	#region PortletProperty Columns
	
	public enum PortletPropertyColumn
	{
		/// <summary></summary>
		PortletID,
	...
	#region PortletProperty Collection
	
	public class PortletPropertyCollection : TableCollection<int, PortletProperty>
	{
	}
