...
{
	[DataObject(true)]
	public partial class CommunityProperty : ITable<int>
	{
		#region Static Methods
		
		#region Common Methods

		protected static CommunityPropertyCollection FillCollection (SqlCommand command)
		{
			CommunityPropertyCollection list = new CommunityPropertyCollection();
			...
			try
			{
				...
				using(SqlDataReader reader = command.ExecuteReader())
				{
					if (reader.HasRows)
					{
						...
						while (reader.Read()) 
						{
							CommunityProperty entity = new CommunityProperty();
		...
		protected static CommunityProperty FillEntity (SqlCommand command)
		{
			CommunityProperty entity = null;
		...
		public static CommunityPropertyCollection GetList (string where, string orderBy)
		{
			StringBuilder sb = new StringBuilder(10);
			
			sb.Append(@"select * from [CommunityProperty] ");
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static CommunityPropertyCollection GetList (string where)
		{
			return GetList(where, String.Empty);
		}
		
		[DataObjectMethod(DataObjectMethodType.Select, true)]
		public static CommunityPropertyCollection GetList ()
		{
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static CommunityProperty GetFirst (string where, string orderBy)
		{
			StringBuilder sb = new StringBuilder(10);
			
			sb.Append(@"select top 1 * from [CommunityProperty] ");
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static CommunityProperty GetFirst (string where)
		{
			return GetFirst(where, String.Empty);
		}
	
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static CommunityProperty GetFirst ()
		{
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static CommunityProperty GetLatest (string where)
		{
			return GetFirst(where, "ModifiedDT desc");
		}
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static CommunityProperty GetLatest ()
		{
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static CommunityProperty GetByCommunityIDAndPropertyGroupAndName(int communityID, string propertyGroup, string name, string orderBy)
		{
			return GetFirst("CommunityID = " + communityID + " and PropertyGroup = '" + propertyGroup + "' and Name = '" + name + "'", orderBy);
		}
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static CommunityProperty GetByCommunityIDAndPropertyGroupAndName(int communityID, string propertyGroup, string name)
		{
			return GetByCommunityIDAndPropertyGroupAndName(communityID, propertyGroup, name, String.Empty);
		}
		...
		protected static bool InsertOrUpdate (int communityID, string propertyGroup, string name, string value)		
		{
			using(SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["ManagedFusion"].ConnectionString))
			{
				using (SqlCommand command = connection.CreateCommand())
				{
					command.CommandText = "ManagedFusion_CommunityProperty";
		...
		public static bool Insert (int communityID, string propertyGroup, string name, string value)
		{
		...
		public static bool Insert (CommunityProperty entity)
		{
		...
		public static bool Update (int communityID, string propertyGroup, string name, string value)
		{
			return InsertOrUpdate(
				communityID,
				propertyGroup,
		...
		public static bool Update (CommunityProperty entity)
		{
			entity.AcceptChanges();
			return InsertOrUpdate(
				entity.CommunityID, 
		...
		public static bool Delete (CommunityProperty entity)
		{
			entity.AcceptChanges();
			return Delete(
				entity.CommunityID, 
		...
		[DataObjectMethod(DataObjectMethodType.Delete, true)]
		public static bool Delete (int communityID, string propertyGroup, string name)
		{
			using(SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["ManagedFusion"].ConnectionString))
			{
				using (SqlCommand command = connection.CreateCommand())
				{
					command.CommandText = "ManagedFusion_CommunityProperty_Delete";
					command.CommandType = CommandType.StoredProcedure;
		...
		/// Column CommunityID : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "CommunityProperty"</remarks>
		...
		///<summary>
		/// Creates a new <see cref="CommunityProperty"/> instance.
		///</summary>
		///<param name="CommunityID"></param>
		///<param name="PropertyGroup"></param>
		///<param name="Name"></param>
		///<param name="Value"></param>
		public CommunityProperty (int communityID, string propertyGroup, string name, string value)
		{
		...
		internal void Merge (CommunityProperty entity)
		{
	...
	#region CommunityProperty Columns
	
	public enum CommunityPropertyColumn
	{
		/// <summary></summary>
		CommunityID,
	...
	#region CommunityProperty Collection
	
	public class CommunityPropertyCollection : TableCollection<int, CommunityProperty>
	{
	}
