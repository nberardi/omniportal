...
namespace ManagedFusion.Modules
{
	...
	public sealed class ModuleAdminAttribute : SkinAttribute
	{
		...
		public ModuleAdminAttribute(string location, string title, string description) : base(title, description) 
		{
			// checks to see if location is set
			if (location == null || location.Length == 0)
				throw new ArgumentException("Location needs to be set for ModuleAdminAttribute.  Cannot be String.Empty or null.", "folderName");
