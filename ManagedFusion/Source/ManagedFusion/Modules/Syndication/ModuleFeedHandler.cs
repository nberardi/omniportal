...
{
	internal class ModuleFeedHandler : BaseSyndicationHandler
	{
		ISyndication _syndication;

		public ModuleFeedHandler(ISyndication syn) 
		{
			this._syndication = syn;
		}

		protected override string CacheKey { get { return "Feed for " + this.SectionInformation.ID.ToString(); } }
